...
class Page(db.Model):
    ...
    created_at = Column(DateTime(timezone=True), nullable=True, server_default= func.utcnow())
    updated_at = Column(DateTime(timezone=True), nullable=True, server_default= func.utcnow(), onupdate=func.now())
